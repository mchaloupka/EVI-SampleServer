...
namespace Slp.Evi.Endpoint.Controllers
{
    public class ResponseWriterHelper : IRdfHandler, ISparqlResultsHandler
    {
        ...
        public ResponseWriterHelper(HttpResponse response, XmlSparqlWriter sparqlWriter, string sparqlContentType, TurtleRdfWriter rdfWriter, string rdfContentType)
        {
            _response = response;
